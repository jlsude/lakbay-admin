    ...
    <div style = "display: flex; flex-direction: row;">
        ...
        gap: 0.75rem; position: fixed;">
            ...
            <div style = "display: flex; flex-direction: column; justify-content: column; gap: calc(100%/7);
                ...
                <button class = "InterfaceButtons" v-on:click = "reDirectAdministrators" disabled>Administrators</button>
        ...
        <div style = "display: flex; flex-direction: column; margin-left: 50vh;">
            ...
            <!-- --------------------- Register Manager -->
            <h2 style="margin-left: 15vh;">Register Admin</h2>
            <div style = "display: flex; flex-direction: row; justify-content: space-around;">
                <div style = "display: flex; flex-direction: column;">
                    

                    <h4 style = "font-size: 2vh; margin-top: 10px; margin-bottom: 5px;">First Name:</h4>
                    <input class = "RegisterInputs" v-model = "admininfo.firstname" 
            ...
            <h2 style="margin-left: 15vh;  margin-top: 10vh;">Admins</h2>
